...
//            specialist.setSpecializationId(1);
...
//            System.out.println("  Pet 1: " + pet1.getName() + " (" + pet1.getSpeciesId() + ")");
//            System.out.println("  Pet 2: " + pet2.getName() + " (" + pet2.getSpeciesId() + ")");
//
//            // Устанавливаем связи
...
//                    System.out.println("  - " + pet.getName() + " (ID: " + pet.getId() + ", " + pet.getSpeciesId() + ")");
//                }
//            }
//
//        } catch (Exception e) {
...
//
//            System.out.println("Creating:");
//            System.out.println("  Pet: " + pet.getName() + " (" + pet.getSpeciesId() + ")");
...
//            specialist1.setSpecializationId(1);
...
//            specialist2.setSpecializationId(2);
